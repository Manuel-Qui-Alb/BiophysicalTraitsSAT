...
location = 'GRAPEX'
path_dir = rf'C:\Users\mqalborn\Desktop\ET_3SEB\{location}\satellite_images\Sentinel2/METADATA.csv'
...
def main(path, out_dir):
    ...
    rho_canopy_vec.loc[:, 'band'] = S2_BANDS
    rho_canopy_vec.to_csv(out_dir + "{}_rho_canopy_vec.csv".format(date_str))
    print(rho_canopy_vec.head())

if __name__ == "__main__":
    path_dir = rf'C:\Users\mqalborn\Desktop\ET_3SEB\GRAPEX\satellite_images\Sentinel2'
    out_dir = rf"C:\Users\mqalborn\Desktop\ET_3SEB\GRAPEX\RTM\prosail\vegetation_spectral_signature_S2SRF"
