...
from pro4sail.biophysical import get_diffuse_radiation_6S, build_soil_database, SRF_LIBRARY, S2_BANDS
...
if __name__ == "__main__":
    ...
    rho_canopy_vec = pd.DataFrame(rho_canopy_vec, columns=S2_BANDS)
    params = pd.DataFrame(params)

    rho_canopy_vec.to_csv(rf'C:\Users\mqalborn\Desktop\BiophysicalTraits/results/rho_canopy_vec.csv')
    params.to_csv(rf'C:\Users\mqalborn\Desktop\BiophysicalTraits/results/prosail.csv')
    # print(rho_canopy_vec)
    print(rho_canopy_vec.shape)
    # print(params)
print('Done TODO!')
