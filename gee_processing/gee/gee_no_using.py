...
class Sentinel2:
    def __init__(self, farm, aoi):
        ...
        self.farm = farm
        self.gee_image_collection = (ee.ImageCollection('COPERNICUS/S2_SR_HARMONIZED')
                                     .filterBounds(aoi)
                                     .map(maskS2clouds))
    ...
    def get_available_dates(self):
        available_dates = self.gee_image_collection.aggregate_array("system:time_start")\
            .map(lambda gee_dates: ee.Date(gee_dates).format('YYYY-MM-dd'))\
            .getInfo()
    ...
    def get_first_image(self):
        return self.gee_image_collection.first()
